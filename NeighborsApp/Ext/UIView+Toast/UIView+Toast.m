...
static const CGFloat CSToastCornerRadius        = 8;
...
// activity
static const CGFloat CSToastActivityWidth       = 80.0f;
static const CGFloat CSToastActivityHeight      = 80.0f;
...
//    UIView *bgview = [[UIView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
//    [bgview setBackgroundColor:[UIColor clearColor]];
    
    
    UIImageView *activityView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, CSToastActivityWidth, CSToastActivityHeight)];
    activityView.center = [self centerPointForPosition:position withToast:activityView];
    activityView.backgroundColor = [UIColor clearColor];
    activityView.alpha = 0.0;
    activityView.autoresizingMask = (UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin | UIViewAutoresizingFlexibleTopMargin | UIViewAutoresizingFlexibleBottomMargin);
    activityView.layer.cornerRadius = CSToastCornerRadius;
    activityView.image = [UIImage imageNamed:@"loadingView_bg"];
    ...
    for (int i = 0; i < 3; i++)
    {
        ...
        theAnimation.timeOffset = i * -0.1;
        theAnimation.removedOnCompletion = FALSE;
        theAnimation.fillMode = kCAFillModeForwards;
        theAnimation.autoreverses = NO;
        theAnimation.fromValue = [NSNumber numberWithFloat:1.0f];
        theAnimation.toValue = [NSNumber numberWithFloat:.3f];
        theAnimation.timingFunction = [CAMediaTimingFunction functionWithName:kCAMediaTimingFunctionEaseInEaseOut];
        [anims addObject:theAnimation];
    }
    ...
    for (int i = 0; i < 3; i++)
    {
        UIView *cView = [[UIView alloc] initWithFrame:CGRectMake(26.5 + i * 10.0f, 65, 7.0f, 7.0f)];
        
        cView.layer.cornerRadius = 3.5f;
        
        cView.backgroundColor = [UIColor colorWithRed:0.9f green:0.9f blue:0.9f alpha:1.0f];
        
        [activityView addSubview:cView];
        
        [cView.layer addAnimation:anims[i] forKey:@"opacityAnimate"];
    }
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        titleLabel.font = [UIFont fontWithName:kNBR_DEFAULT_FONT_NAME size:CSToastFontSize];
    ...
    if (message != nil) {
        ...
        messageLabel.font = [UIFont fontWithName:kNBR_DEFAULT_FONT_NAME size:CSToastFontSize];
